        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body ">
                    <%--供应商搜索回显--%>
                    <form class="layui-form layui-col-space5" action="/SupplierServlet?action=list" method="post">
                        <div class="layui-inline layui-show-xs-block">
                            <input type="text" id="name" name="name" placeholder="请输入供应商名" autocomplete="off" class="layui-input" value="${requestScope.name}"/>
                        </div>
                        <div class="layui-inline layui-show-xs-block">
                    ...
                    <table class="layui-table layui-form">
                        ...
                        <c:forEach items="${requestScope.suppliersList}" var="p">
                            <tr>
                                ...
                                <td>${p.description}</td>
                                <td class="td-manage">
                                    <a title="个人信息"  onclick="xadmin.open('个人信息','/SupplierServlet?action=details&id=${p.id}',600,400)" href="javascript:;">
                                        <i class="layui-icon">&#xe66e;</i>
                                    </a>
                                    <a title="编辑"  onclick="xadmin.open('编辑','/SupplierServlet?action=goUpdate&id=${p.id}',600,400)" href="javascript:;">
                                        <i class="layui-icon">&#xe642;</i>
                                    </a>
